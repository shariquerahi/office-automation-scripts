...
# Define file paths
big_file_path = '/Users/shariquerahi/Desktop/Reconsile Merchant Data/DC_Amazon_63606.csv'
small_file_path = '/Users/shariquerahi/Downloads/DC Recon data Oct - Amazon.csv'
output_dir = '/Users/shariquerahi/Desktop/Git/Python_Script/Amazon_Output.csv'
...
small_file.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Downloads/DC Recon data Oct - Amazon.csv'), index=False)
...
result.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Desktop/Git/Python_Script/Amazon_Output.csv'), index=False)
...
df_big_file = pd.read_csv('/Users/shariquerahi/Desktop/Reconsile Merchant Data/DC_Amazon_63606.csv', parse_dates=['transaction_date'])

df_small_file = pd.read_csv('/Users/shariquerahi/Downloads/DC Recon data Oct - Amazon.csv', parse_dates=['transaction_date'])


#df_output = pd.read_csv('/Users/shariquerahi/Desktop/Git/Python_Script/Amazon_Output.csv', parse_dates=['transaction_date'])
