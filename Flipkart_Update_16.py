...
# Define file paths
big_file_path = '/Users/shariquerahi/Desktop/Git/Python_Script/CSV_Files/Flipkart_updated_db.csv'
small_file_path = '/Users/shariquerahi/Downloads/Flipkart recon Fi_Till Date Data.xlsx - Base_Till Date (1).csv'
output_dir = '/Users/shariquerahi/Desktop/Git/Python_Script/Flipkart_output.csv'
...
small_file.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Downloads/Flipkart recon Fi_Till Date Data.xlsx - Base_Till Date (1).csv'), index=False)
...
amount_tolerance = 0.99  # Tolerance of 2 for Authorization_amount
...
result.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Desktop/Git/Python_Script/Flipkart_output.csv'), index=False)
...
unmatched_result.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Desktop/Git/Python_Script/Flipkar_unmatched.csv'), index=False)

# Read the CSV file into a DataFrame
df_big_file = pd.read_csv('/Users/shariquerahi/Desktop/Git/Python_Script/CSV_Files/Flipkart_updated_db.csv', parse_dates=['transaction_date'])

df_small_file = pd.read_csv('/Users/shariquerahi/Downloads/Flipkart recon Fi_Till Date Data.xlsx - Base_Till Date (1).csv', parse_dates=['transaction_date'])


#df_output = pd.read_csv('/Users/shariquerahi/Desktop/Git/Python_Script/Flipkart_output.csv', parse_dates=['transaction_date'])
