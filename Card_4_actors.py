...
csv_input_path = "/Users/shariquerahi/Downloads/2023-11-08T16_35_35 (1).csv"
csv_output_path = "/Users/shariquerahi/Desktop/Git/Python_Script/CSV_Files/output_DC_Account.csv"
...
def append_to_results(actor_id, dbinfo):
    if dbinfo:
        ...
        card_id, state, card_form = None, None, None

    row = [actor_id, card_id,state, card_form]
...
df = pd.DataFrame(card_results, columns=['actor_id', 'cardId','state','card_form'])
