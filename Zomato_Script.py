...
small_file_path = '/Users/shariquerahi/Downloads/Flipkart recon Fi_Till Date Data.xlsx - Sheet1.csv'
...
small_file.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Downloads/Flipkart recon Fi_Till Date Data.xlsx - Sheet1.csv'), index=False)
...
df_small_file = pd.read_csv('/Users/shariquerahi/Downloads/Flipkart recon Fi_Till Date Data.xlsx - Sheet1.csv', parse_dates=['transaction_date'])


#df_output = pd.read_csv('/Users/shariquerahi/Desktop/Git/Python_Script/CSV_Files/Zomato.output.csv', parse_dates=['transaction_date'])
...
unmatched_result_small.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Desktop/Git/Python_Script/CSV_Files/unmatched_zomTO_small.csv'), index=False)
