...
# Define file paths
big_file_path = '/Users/shariquerahi/Downloads/Amazon_db_data.csv'
...
df_big_file = pd.read_csv('/Users/shariquerahi/Downloads/Amazon_db_data.csv', parse_dates=['transaction_date'])
