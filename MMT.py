...
# Define file paths
big_file_path = '/Users/shariquerahi/Downloads/dc_mmt.csv'
small_file_path = '/Users/shariquerahi/Downloads/DC recon Master - updated 13oct - MMT June.csv'
output_dir = '/Users/shariquerahi/Desktop/Git/Python_Script/CSV_Files/DC_Output.csv'
...
small_file.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Downloads/DC recon Master - updated 13oct - MMT June.csv'), index=False)
...
result.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Desktop/Git/Python_Script/CSV_Files/DC_Output.csv'), index=False)
...
df_big_file = pd.read_csv('/Users/shariquerahi/Downloads/dc_mmt.csv', parse_dates=['transaction_date'])

df_small_file = pd.read_csv('/Users/shariquerahi/Downloads/DC recon Master - updated 13oct - MMT June.csv', parse_dates=['transaction_date'])


#df_output = pd.read_csv('/Users/shariquerahi/Desktop/Git/Python_Script/CSV_Files/DC_Output.csv', parse_dates=['transaction_date'])
