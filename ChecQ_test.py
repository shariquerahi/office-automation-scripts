...
# Define file paths
big_file_path = '/Users/shariquerahi/Downloads/part-00000-6eddd8ec-8914-46a9-a6b4-1c759796116c-c000.csv'
small_file_path = '/Users/shariquerahi/Downloads/Flipkart recon Fi_Till Date Data.xlsx - Base_Till Date.csv'
...
amount_tolerance = 2  # Tolerance of 2 for Authorization_amount
...
unmatched_result_small = small_file.merge(
    result, on=['Card_last_4_digit'], how='left', indicator=True
).loc[lambda x: x['_merge'] == 'left_only']

# Save the unmatched small file rows to a new CSV file
unmatched_result_small.to_csv(os.path.join(output_dir, '/Users/shariquerahi/Desktop/Git/Python_Script/flipkart_data.csv'), index=False)
